...
//#define DECL_LOGGER(logger) static log4cxx::Logger logger;
//#define IMPL_LOGGER(classname, logger) log4cxx::Logger classname::logger = log4cxx::Logger::getinstance(#classname);
